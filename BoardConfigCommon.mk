...
ifeq ($(PRODUCT_RETROFIT_DYNAMIC_PARTITIONS), true)
BOARD_SUPER_PARTITION_GROUPS := msm8953_dynamic_partitions
BOARD_MSM8953_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product system_ext odm
$(foreach p, $(call to-upper, $(BOARD_MSM8953_DYNAMIC_PARTITIONS_PARTITION_LIST)), \
    $(eval BOARD_$(p)IMAGE_FILE_SYSTEM_TYPE := ext4) \
    $(eval TARGET_COPY_OUT_$(p) := $(call to-lower, $(p))))
BOARD_SUPER_PARTITION_SIZE := 3850371072
BOARD_MSM8953_DYNAMIC_PARTITIONS_SIZE := 3846176768
